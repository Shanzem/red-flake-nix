...
final: prev: {
  ...
  JoomlaScan = final.python312Packages.buildPythonApplication rec {
    pname = "JoomlaScan";
    ...
    postPatch = ''
      ${final.python312}/bin/2to3 -w joomlascan.py
    ...
    installPhase = ''
      ...
      makeWrapper ${final.python312.withPackages (_ps: propagatedBuildInputs)}/bin/python $out/bin/joomlascan \
